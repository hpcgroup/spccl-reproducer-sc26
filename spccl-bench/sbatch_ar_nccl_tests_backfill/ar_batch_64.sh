...
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./build/all_reduce_perf_mpi -g 1 -b 268435456 -e 268435456 -z 1 -d half -n $ITERS -w $WARMUPS | \
    tee /dev/stderr | \
...
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./build/all_reduce_perf_mpi -g 1 -b 536870912 -e 536870912 -z 1 -d half -n $ITERS -w $WARMUPS | \
    tee /dev/stderr | \
...
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./build/all_reduce_perf_mpi -g 1 -b 1073741824 -e 1073741824 -z 1 -d half -n $ITERS -w $WARMUPS | \
    tee /dev/stderr | \
...
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./build/all_reduce_perf_mpi -g 1 -b 2147483648 -e 2147483648 -z 1 -d half -n $ITERS -w $WARMUPS | \
    tee /dev/stderr | \
...
unset NCCL_MAX_NCHANNELS
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./build/all_reduce_perf_mpi -g 1 -b 268435456 -e 268435456 -d half -n $ITERS -w $WARMUPS | \
    tee /dev/stderr | \
...
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./build/all_reduce_perf_mpi -g 1 -b 536870912 -e 536870912 -d half -n $ITERS -w $WARMUPS | \
    tee /dev/stderr | \
...
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./build/all_reduce_perf_mpi -g 1 -b 1073741824 -e 1073741824 -d half -n $ITERS -w $WARMUPS | \
    tee /dev/stderr | \
...
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./build/all_reduce_perf_mpi -g 1 -b 2147483648 -e 2147483648 -d half -n $ITERS -w $WARMUPS | \
    tee /dev/stderr | \
...
srun -N 16 -n 64 --ntasks-per-node=4 -c 32 --cpu-bind=cores --mem-bind=local \
    ./bin/test_spallreduce_fp32_stock_ncclx nccl_dense 1 $UNIFORM $ITERS $WARMUPS $CSV \
